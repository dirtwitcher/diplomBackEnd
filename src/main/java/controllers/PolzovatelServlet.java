...
public class PolzovatelServlet extends HttpServlet {
	...
	System.out.println("Enter Polzovatel doPut");
	...
	PolzovatelService polzovatelService = new PolzovatelService();
	polzovatelService.updatePolzovatel(polzovatel);
	...
	System.out.println("Enter Polzovatel doDelete");
	...
	PolzovatelService polzovatelService = new PolzovatelService();
	polzovatelService.deletePolzovatel(polzovatel);
