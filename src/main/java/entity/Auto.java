...
public class Auto {
    ...
    // @OneToMany(fetch = FetchType.LAZY, mappedBy = "id_auto", cascade =
    // CascadeType.ALL)
...
//    @Column(name = "dvigatel", length = 25) // no sense
...
//    }
    /*
     * public TypeAuto getId_typeAuto() { return id_typeAuto; }
     * 
     * public void setId_typeAuto(TypeAuto id_typeAuto) { this.id_typeAuto =
     * id_typeAuto; }
     * 
     * public Dvigatel getDvigatelObj() { return dvigatelObj; }
     * 
     * public void setDvigatelObj(Dvigatel dvigatelObj) { this.dvigatelObj =
     * dvigatelObj; }
     * 
     * public Kpp getKppObj() { return kppObj; }
     * 
     * public void setKppObj(Kpp kppObj) { this.kppObj = kppObj; }
     * 
     * public List<KuzovnieDetali> getKuzovnieDetaliList() { return
     * kuzovnieDetaliList; }
     * 
     * public void setKuzovnieDetaliList(List<KuzovnieDetali> kuzovnieDetaliList) {
     * this.kuzovnieDetaliList = kuzovnieDetaliList; }
     * 
     * public List<ToplivnayaSistema> getToplivnayaSistemaList() { return
     * toplivnayaSistemaList; }
     * 
     * public void setToplivnayaSistemaList(List<ToplivnayaSistema>
     * toplivnayaSistemaList) { this.toplivnayaSistemaList = toplivnayaSistemaList;
     * }
     * 
     * public List<DopTovari> getDopTovariList() { return dopTovariList; }
     * 
     * public void setDopTovariList(List<DopTovari> dopTovariList) {
     * this.dopTovariList = dopTovariList; }
     * 
     * public List<Podveska> getPodveskaList() { return podveskaList; }
     * 
     * public void setPodveskaList(List<Podveska> podveskaList) { this.podveskaList
     * = podveskaList; }
     * 
     * public List<Transmissiya> getTransmissiyaList() { return transmissiyaList; }
     * 
     * public void setTransmissiyaList(List<Transmissiya> transmissiyaList) {
     * this.transmissiyaList = transmissiyaList; }
     * 
     * public List<OsnaschKuzova> getOsnaschKuzovaList() { return osnaschKuzovaList;
     * }
     * 
     * public void setOsnaschKuzovaList(List<OsnaschKuzova> osnaschKuzovaList) {
     * this.osnaschKuzovaList = osnaschKuzovaList; }
     * 
     * public List<SistemaOhlajdeniya> getSistemaOhlajdeniyaList() { return
     * sistemaOhlajdeniyaList; }
     * 
     * public void setSistemaOhlajdeniyaList(List<SistemaOhlajdeniya>
     * sistemaOhlajdeniyaList) { this.sistemaOhlajdeniyaList =
     * sistemaOhlajdeniyaList; }
     * 
     * public List<Elektrika> getElektrikaList() { return elektrikaList; }
     * 
     * public void setElektrikaList(List<Elektrika> elektrikaList) {
     * this.elektrikaList = elektrikaList; }
     * 
     * public List<RulevoeUpravlenie> getRulevoeUpravlenieList() { return
     * rulevoeUpravlenieList; }
     * 
     * public void setRulevoeUpravlenieList(List<RulevoeUpravlenie>
     * rulevoeUpravlenieList) { this.rulevoeUpravlenieList = rulevoeUpravlenieList;
     * }
     * 
     * public List<OtoplenieKondei> getOtoplenieKondeiList() { return
     * otoplenieKondeiList; }
     * 
     * public void setOtoplenieKondeiList(List<OtoplenieKondei> otoplenieKondeiList)
     * { this.otoplenieKondeiList = otoplenieKondeiList; }
     * 
     * public List<OsvetPribory> getOsvetPriboryList() { return osvetPriboryList; }
     * 
     * public void setOsvetPriboryList(List<OsvetPribory> osvetPriboryList) {
     * this.osvetPriboryList = osvetPriboryList; }
     * 
     * public List<Tormoza> getTormozaList() { return tormozaList; }
     * 
     * public void setTormozaList(List<Tormoza> tormozaList) { this.tormozaList =
     * tormozaList; }
     * 
     * public List<KorpusaPatrubki> getKorpusaPatrubkiList() { return
     * korpusaPatrubkiList; }
     * 
